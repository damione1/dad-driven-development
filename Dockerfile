...
RUN addgroup -g 1000 personal-website && \
    adduser -D -u 1000 -G personal-website personal-website
...
RUN mkdir -p /app/pb_data && \
    chown -R personal-website:personal-website /app
...
CMD ["./personal-website", "serve", "--http=0.0.0.0:8090"]
